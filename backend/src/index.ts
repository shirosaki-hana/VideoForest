...
async function createFastifyApp() {
    ...
    fastify.get('/coffee', async (request, reply) => {
      return reply.code(418).sendFile('teapot.html', path.join(__dirname, '../../frontend/public'));
    });
    ...
    .then(fastify => {
      ...
      const gracefulShutdown = async (signal: string) => {
        ...
        try {
          ...
          logger.success('Goodbye! See you again!');
        } catch (error) {
