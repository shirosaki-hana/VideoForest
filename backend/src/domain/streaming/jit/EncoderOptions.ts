...
export class EncoderOptions {
   ...
   */
  private static buildCPUVideoArgs(
    profile: QualityProfile, 
    gopSize: number, 
    keyframeExpr: string,
    speedMode: boolean
...
export const buildVideoEncoderArgs = (
  profile: QualityProfile,
  analysis: MediaAnalysis,
  speedMode?: boolean
) => EncoderOptions.buildVideoArgs(profile, analysis, speedMode);

export const buildAudioEncoderArgs = (
  profile: QualityProfile,
  analysis: MediaAnalysis
) => EncoderOptions.buildAudioArgs(profile, analysis);

export const buildVideoFilter = (
  profile: QualityProfile,
  analysis: MediaAnalysis
) => EncoderOptions.buildVideoFilter(profile, analysis);
